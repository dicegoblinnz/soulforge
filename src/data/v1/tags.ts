...
export const tags: Tag[] = [
  ...
  // Mundane materials
  {
    ...
    name: "Wood",
    description: "",
    categories: [ETagCategories.MUNDANE],
  },
  {
    id: 15,
    name: "Leather",
  ...
  // Enhanced materials
  {
    ...
    name: "Steel",
    description: "",
    categories: [ETagCategories.ENHANCED],
  },
  {
    id: 22,
  ...
  // Exotic materials
  {
    ...
    name: "Mithril",
    description: "",
    categories: [ETagCategories.EXOTIC],
  },
  {
    id: 29,
    name: "Adamantite",
  ...
  // Mythic materials
  {
    ...
    name: "Ebony Wood",
    description: "",
    categories: [ETagCategories.MYTHICAL],
  },
  {
    id: 36,
    name: "Abnu Forged",
  ...
  // Kinfolk
  {
    ...
    categories: [ETagCategories.KINFOLK, ETagCategories.HUMAN],
  },
  {
    id: 71,
    name: "Determined",
  ...
  },
  {
    ...
    categories: [ETagCategories.KINFOLK, ETagCategories.GIANTFOLK],
  },
  {
    id: 74,
    name: "Blood Bond",
  ...
  },
  {
    ...
    categories: [ETagCategories.KINFOLK, ETagCategories.ELF],
  },
  {
    id: 77,
  ...
  },
  {
    ...
    categories: [ETagCategories.KINFOLK, ETagCategories.DWARF],
    exhaust: {
  ...
  },
  {
    ...
    categories: [ETagCategories.KINFOLK, ETagCategories.SMALLFOLK],
  },
  {
    id: 83,
    name: "Resourceful",
  ...
  },
  {
    ...
    categories: [ETagCategories.KINFOLK, ETagCategories.BEASTFOLK],
    exhaust: {
  ...
  },
  {
    ...
    categories: [ETagCategories.KINFOLK, ETagCategories.LIZARDFOLK],
    exhaust: {
  ...
  },
  {
    ...
    categories: [ETagCategories.KINFOLK, ETagCategories.BIRDFOLK],
    exhaust: {
  ...
  },
  {
    ...
    categories: [ETagCategories.KINFOLK, ETagCategories.MERFOLK],
    exhaust: {
  ...
  },
  {
    ...
    categories: [ETagCategories.KINFOLK, ETagCategories.BOGFOLK],
  },
  {
    id: 98,
    name: "Elastic Tongue",
  ...
  },
  {
    ...
    categories: [ETagCategories.KINFOLK, ETagCategories.DRAGONFOLK],
    exhaust: {
  ...
  },
  {
    ...
    categories: [ETagCategories.KINFOLK, ETagCategories.INSECTFOLK],
    exhaust: {
  ...
  },
  {
    ...
    categories: [ETagCategories.KINFOLK, ETagCategories.SOULBOUND],
  },
  {
    id: 107,
    name: "Modular V2",
  ...
  // Condition Tags
  {
    id: 157,
    name: "Burning",
    description: "Suffer 1 Fire damage at the end of your turn. Use an action to Break this tag.",
    categories: [ETagCategories.CONDITIONS],
  },
  {
    id: 158,
    name: "Frozen",
    description: "Unable to take actions. Fire damage or an ally using an action can Break this tag.",
    categories: [ETagCategories.CONDITIONS],
  },
  {
    id: 159,
    name: "Staggered",
    description: "Get a -1 on your highest Dice. Use an action to Break this tag.",
    categories: [ETagCategories.CONDITIONS],
  },
  {
    id: 160,
    name: "Exhausted",
    description: "Suffer a -1 on your highest die roll (does not affect explosions). Use a downtime action to eliminate this tag.",
    categories: [ETagCategories.CONDITIONS],
  },
  {
    id: 161,
    name: "Fear",
    description: "Cannot approach source of fear, and suffer -1 dice when taking actions in its presence. Leave line of sight of fear and use an action to compose yourself to eliminate tag.",
    categories: [ETagCategories.CONDITIONS],
  },
  {
    id: 162,
    name: "Hasted",
    description: "Movement speed doubled and you gain an extra action. Break tag to gain 5 actions.",
    categories: [ETagCategories.CONDITIONS],
  },
  {
    id: 163,
    name: "Inspired",
    description: "You gain Inspiration Tag. Break tag to gain a d4 Inspiration dice.",
    categories: [ETagCategories.CONDITIONS],
  },
  {
    id: 164,
    name: "Blessed",
    description: "Explode on 1s on die rolls. Break tag to gain an inspiration die.",
    categories: [ETagCategories.CONDITIONS],
  },
  {
    id: 165,
    name: "Charmed",
    description: "Social checks against the charmed creature are made with advantage; you consider the source of charm to be friendly. An ally must use an action to eliminate the charmed tag.",
    categories: [ETagCategories.CONDITIONS],
  },
  {
    id: 166,
    name: "Blinded",
    description: "Lose 1 Dice on all sight-based actions. Tag can only Break by healing or spending recovery on it.",
    categories: [ETagCategories.CONDITIONS],
  },
  {
    id: 167,
    name: "Silenced",
    description: "Unable to speak, preventing sound-based abilities or communication. Break by leaving range of influence.",
    categories: [ETagCategories.CONDITIONS],
  },
  {
    id: 168,
    name: "Restrained",
    description: "Unable to move. Tag can be eliminated using an action to contest the source and break free.",
    categories: [ETagCategories.CONDITIONS],
  },
  {
    id: 169,
    name: "Invisible",
    description: "Cannot be targeted by sight, and gain a d20 on all stealth-based actions. Tag can Break to perform an aggressive action on a target with a d20.",
    categories: [ETagCategories.CONDITIONS],
  },
  {
    id: 170,
    name: "Exhausted (Alternate)",
    description: "You lose 1 action dice. Break this by spending a recovery point on it during rests.",
    categories: [ETagCategories.CONDITIONS],
  },
  {
    id: 171,
    name: "Empowered",
    description: "Increase the potency of one of your attributes, gaining d8 on all actions. Break this Tag to gain a Flow dice of d12.",
    categories: [ETagCategories.CONDITIONS],
  },
  {
    id: 172,
    name: "Bleeding",
    description: "Enemy gets a +1 on any of their dice. Break this Tag by using an action.",
    categories: [ETagCategories.CONDITIONS],
  },
];